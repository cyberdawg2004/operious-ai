...
const workItems: NavItem[] = [
  ...
  { id: "conversations", href: dashboardRoutes.conversations, label: "Live Conversations", icon: MessageSquare },
  { id: "inbox", href: dashboardRoutes.inbox, label: "Conversation Inbox", icon: MailOpen },
