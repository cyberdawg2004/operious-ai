...
const workItems: NavItem[] = [
  ...
  { id: "conversations", href: dashboardRoutes.conversations, label: "Live Customer Chat", icon: MessageSquare },
  { id: "inbox", href: dashboardRoutes.inbox, label: "Conversation History", icon: MailOpen },
  { id: "assistant", href: dashboardRoutes.assistant, label: "Ask the Assistant", icon: BotMessageSquare },
