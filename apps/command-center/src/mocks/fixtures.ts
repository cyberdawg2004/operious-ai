...
export const TOPOLOGY_FIXTURE: TopologyGraphDto = {
  ...
  nodes: [
    ...
    {
      nodeId: brand<'TopologyNodeId'>('node-gov-domain'),
      kind: 'governance_domain',
      label: 'pii.compliance.acme',
      metadata: { framework: 'GDPR/CCPA' },
    },
    {
      nodeId: brand<'TopologyNodeId'>('node-boundary'),
      kind: 'authority_boundary',
      label: 'tenant.acme ⟂ tenant.lyra',
      metadata: { isolation: 'tenant' },
    },
    {
      nodeId: brand<'TopologyNodeId'>('node-escalation'),
  ...
  edges: [
    ...
    {
      edgeId: brand<'TopologyEdgeId'>('edge-supervisor-escalation'),
      kind: 'escalation',
      source: brand<'TopologyNodeId'>('node-supervisor'),
      target: brand<'TopologyNodeId'>('node-escalation'),
      label: 'human handoff',
      metadata: {},
    },
    {
      edgeId: brand<'TopologyEdgeId'>('edge-frontline-gov'),
      kind: 'governance_attachment',
      source: brand<'TopologyNodeId'>('node-frontline'),
      target: brand<'TopologyNodeId'>('node-gov-domain'),
      label: 'governed by',
      metadata: {},
    },
    {
      edgeId: brand<'TopologyEdgeId'>('edge-supervisor-boundary'),
      kind: 'authority_boundary',
      source: brand<'TopologyNodeId'>('node-supervisor'),
      target: brand<'TopologyNodeId'>('node-boundary'),
      label: 'isolation',
      metadata: {},
    },
  ],
