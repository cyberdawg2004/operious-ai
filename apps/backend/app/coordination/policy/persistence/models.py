"""Coordination-policy query / page shapes — storage-agnostic."""
...
class CoordinationPolicyQuery:
    """Query parameters for retrieving coordination-policy records.
...
__all__ = ["CoordinationPolicyQuery", "RecordPage"]
