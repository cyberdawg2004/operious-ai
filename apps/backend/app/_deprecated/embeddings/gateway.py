...
from app._deprecated.embeddings.retry import RetryPolicy, retry_async
from app._deprecated.embeddings.tracing import _EmbeddingTraceBuilder
from app.observability.context import get_request_id
from app._deprecated.observability.embedding_logging import (
    log_embedding_attempt,
    log_embedding_execution,
)
from app._deprecated.observability.embedding_metrics import record_embedding_usage
