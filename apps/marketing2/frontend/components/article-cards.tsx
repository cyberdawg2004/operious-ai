...
const articles = [
  {
    ...
    excerpt:
      "Why policy-as-prompt fails the enterprise audit test and how admission tokens change the control plane.",
  ...
  },
  {
    ...
    excerpt:
      "How deterministic identity and event fabrics make AI operations defensible after the fact.",
    readingTime: "12 min read",
    href: "/insights/reconstructible-truth",
  },
  {
    meta: "ENGINEERING · REPLAY",
    title: "Beyond LLM wrappers: what infrastructure really means.",
    excerpt:
      "The seven substrates that separate governed execution infrastructure from model orchestration.",
