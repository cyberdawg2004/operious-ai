...
export function AnimatedGradientText({
  ...
  return (
    ...
    >
      <div className="absolute inset-0 block h-full w-full animate-gradient rounded-[inherit] bg-gradient-to-r from-[#2A5CAA]/50 via-[#C9A84C]/50 to-[#2A5CAA]/50 bg-[length:var(--bg-size)_100%] p-px [mask:linear-gradient(#fff_0_0)_content-box,linear-gradient(#fff_0_0)] [mask-composite:exclude]" />
      {children}
    </div>
  );
}
