  ...
  return (
    <section className="bg-canvas py-[160px] px-16">
      <div className="max-w-[1280px] mx-auto">
        {/* Section Header */}
        <div className="mb-16">
          <span className="font-mono text-[11px] uppercase tracking-[0.18em] text-gold block mb-4">
            §07 · WRITING
          </span>
          <h2 className="font-cormorant-sc text-[64px] font-bold text-ink-primary leading-[1.1] mb-6">
            Operational substrate thinking.
          </h2>
          <p className="font-sans text-[18px] text-ink-body leading-relaxed max-w-[760px]">
        ...
        <div className="grid grid-cols-3 gap-8">
          {articles.map((article, index) => (
            <motion.article
              key={index}
              className="bg-white border border-[var(--border-subtle)] rounded-lg p-8 flex flex-col gap-3 cursor-pointer"
            ...
            >
              ...
              {/* Title */}
              <h3 className="font-cormorant-sc text-[24px] font-semibold leading-[1.3] text-ink-primary mt-2">
                {article.title}
              </h3>
